 ...
 */
public class QuanLySoDiem extends javax.swing.JFrame {
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        if (conn.getData_SoDiem(sql) != null) {
            arr_SoDiem = conn.getData_SoDiem(sql);
        }
        }
        catch (Exception e) {
            System.out.println(e.getMessage());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (dlr == JOptionPane.YES_OPTION) {
            ...
            if (selectedRow > -1) {
                ...
                arr_SoDiem.clear();
                String sql_sv = "Select * from SoDiem";
                if (conn.getData_SoDiem(sql_sv) != null) {
                    arr_SoDiem = conn.getData_SoDiem(sql_sv);
                }           
        LoadTable();
        XoaTrang();
...
//throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuanLySoDiem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuanLySoDiem().setVisible(true);
            }
        });
    }
